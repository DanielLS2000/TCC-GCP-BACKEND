...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = get_secret('CUSTOMER_DB_URL') if os.environ.get('KUBERNETES_DEPLOYMENT') else os.environ.get("DATABASE_URL", "postgresql://postgres:password@localhost:5432/customer_db")
